...
[Prettier](https://prettier.io/) with the
[Flare shared configurations](https://github.com/flare-foundation/flare-handbook).
...
Releases are tagged from the `main` branch following
